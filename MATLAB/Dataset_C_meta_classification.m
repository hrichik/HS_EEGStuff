...
disp(['Parameters made!']);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

for vp = 1 : length(subdir_list.eeg)
    %rng(vp);
    ...
    disp(['Band Selection for CSP Done!']);
...
time = ival(:,2);
figure(1)
plot(time/1000,[mean(mean_acc.eeg)]); %removed mean(mean_acc.meta1); mean(mean_acc.meta4%
